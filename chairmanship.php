							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Bidding Project Category</div>
														...
														<tr>
															...
															<td>
																<div class="form-button-action">
																	<a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit Title" onclick="editChair(this)" data-title="<?= $row['title'] ?>" data-id="<?= $row['id'] ?>">
																		<i class="fa fa-edit"></i>
																	</a>
																	<a type="button" data-toggle="tooltip" href="model/remove_chair.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this title?');" class="btn btn-link btn-danger" data-original-title="Remove">
						...
						<div class="modal-body">
							<form method="POST" action="model/save_chairmanship.php">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Project Category" name="chair" required>
								</div>
						</div>
